    ...
    return (
        <div className="py-12 bg-gray-900">
            ...
            <div className="mt-20 text-center">
                <Link href={"/courses"} className="px-4 py-2 text-neutral-600 bg-white hover:bg-gray-700 hover:text-white transition duration-200 rounded-3xl">View All Courses</Link>
            </div>
        </div>
    )
}
